...
namespace _05._Slicing_File
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string destinationDirectory = "../ResultFiles";
            ...
            string assembledDirectory = "../ResultFiles";
        ...
        {
            using (FileStream destination = new FileStream($"{destinationDirectory}/assembledFile.mp4", FileMode.Create))
            {
